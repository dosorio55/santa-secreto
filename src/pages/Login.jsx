...
const Login = ({ setToken, users, alert, setAlert, loadingNames }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      if (!formValue.name) {
        throw Error("Por Favor selecciona un nombre");
      }
      ...
      if (serverResponse.status === 200) {
        ...
        setError(true);
        throw Error("Credenciales incorrectos, por favor intenta de nuevo");
      } else {
